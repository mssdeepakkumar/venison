...
<tr>
	...
	<th
		align="right"
		width="170px"><?php echo vmText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?>
...
foreach ($this->cart->products as $pkey => $prow) {
	...
	?>
<tr valign="top" class="repeat_cart_row sectiontableentry<?php echo $i ?>">
	<td align="left">
...
<tr class="text_blk_td sectiontableentry1">
...
if (VmConfig::get ('coupons_enable')) {
	?>
<tr class="sectiontableentry2 cpn_code_ipt">
...
<tr class="sectiontableentry2">
	<td class="ttl_crt_prc" colspan="4" align="right"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>:</td>
