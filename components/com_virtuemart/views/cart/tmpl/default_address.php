...
<div class="billto-shipto">
	<div class="width50 floatleft cart_addrss_ui">

		<span class="cmn_hd_cart"><!-- <span class="vmicon vm2-billto-icon"></span> -->
		...
		<a class="details btn-custm" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
	...
	<div class="width50 floatleft cart_addrss_ui">
		...
		<span class="cmn_hd_cart"><!-- <span class="vmicon vm2-shipto-icon"> </span>-->
		...
		<a class="details btn-custm" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
