...
<div class="cart-view cntnt_shp_ui">   
	<div class="vm-cart-header-container">
		<div class="width50 floatleft vm-cart-header">
			<h1><?php echo vmText::_ ('COM_VIRTUEMART_CART_TITLE'); ?>
				<div class="pull-right vm-continue-shopping">
	...
	?><form method="post" id="checkoutForm" name="checkoutForm" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart' . $taskRoute, $this->useXHTML, $this->useSSL); ?>">
		...
		?> <div class="btn_chk_me_ot checkout-button-top"> <?php
